...
import { dashboardSelector, userlogin, getActivities, getHirings, getInterviewAndHiredDetails, getPostedJobList, getTodayMeetingDetailsList, getUpcomings, getPostedJobActiveList, getCalendarDetails } from "@/store/reducers/dashboard";
...
console.log(inactiveJobsData,'inactiveJobsData')
  //tab end
  return (
    <main className="">
                  ...
                  <Box sx={{ width: "100%" }}>
                    ...
                    <CustomTabPanel className="p-0" value={value} index={0}>
                      <div className="row px-3 pb-3">
                        {/* {inactiveJobsData && inactiveJobsData?.map((job: any, index: any) => (
                    ...
                    >
                      <div className="row px-3 pb-3">
                        {/* {activeJobsData && activeJobsData?.map((job: any, index: any) => (
                          <PostedJobsCard key={index} {...job} />
                        ))} */}
                      </div>
                    </CustomTabPanel>
